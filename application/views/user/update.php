        ...
        <form method="post" action="<?= base_url('user/update/' . $item->id) ?>">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="nohp" id="exampleInputEmail1" aria-describedby="emailHelp"
                    placeholder="Alamat" value="<?= $item->nohp ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="exampleInputEmail1">No_Telponan</label>
                <input type="text" class="form-control" name="jurusan" id="exampleInputEmail1"
                    aria-describedby="emailHelp" placeholder="No_Telpon" value="<?= $item->jurusan ?>">
            </div>


            <button type="submit" class="btn btn-warning btn-danger">UBAH</button>
        </form>
    </div>
</body>
